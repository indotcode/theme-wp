<?php
$goods = Plugins::CatsResultFilter();
//echo '<pre>';
//print_r($_SESSION);
//echo '</pre>';
get_header(); ?>
                ...
                <div class="filter">
                    <div class="filter__wrapper wrapper">
                        ...
                        <div class="filter__content">
                            <form action="" method="post" class="ajax-jq">
                                <input type="hidden" name="type" value="filter_goods">
                                <div class="filter__tab filter__tab--show">
                                    <a class="filter__tab-link" href="">Категории товаров</a>
                                    <div class="filter__tab-content">
                                        ...
                                        foreach ($terms as $item){ ?>
                                            <div class="filter__check">
                                                <input class="filter__input-ckeck visiually-hidden" id="cats<?=$item->term_id?>" name="<?=$item->taxonomy?>" type="radio" value="<?=$item->term_id?>">
                                                <label class="filter__label" for="cats<?=$item->term_id?>"><?=$item->name?></label>
            ...
            <div class="shop__field">
                ...
                <div class="shop__setting-wrapper">
                    ...
                    <form class="shop__setting-grid ajax-jq" action="/wp-ajax/index.php" method="post">
                        ...
                        <button type="submit" value="row" id="rowGrid" class="basket-control_submitter <?=$_SESSION['grid'] == 'row' ? 'shop__setting-grid-active' : ''?>">
                            <svg width="24" height="18" viewBox="0 0 24 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <rect width="24" height="7.5" fill="#BDBDBD"/>
                                <rect y="10.5" width="24" height="7.5" fill="#BDBDBD"/>
                            </svg>
                        </button>
                        <button type="submit" value="column" id="columnGrid" class="basket-control_submitter <?=$_SESSION['grid'] == 'column' ? 'shop__setting-grid-active' : ''?>">
