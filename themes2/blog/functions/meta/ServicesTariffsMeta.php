...
function admin_head_style_tariffs() {
    if(IsPost(get_post()->ID, 'Тарифы') == true){
        ?>
        <script>
        ...
        <script type="text/html" id="tmpl-Rate">
            <div class="item">
                ...
                <div class="description">
                    <textarea name="extra[rate][{{data.id}}][description]" id="" placeholder="Краткое описание"></textarea>
                </div>
                ...
                <div class="item">
                    ...
                    <div class="date">
                        ...
                        <select name="extra[rate][<?=$key?>][date-name]">
                            ...
                            <option <?=$val['date-name'] == 'Час' ? 'selected' : ''?> value="Час">Час</option>
                            <option <?=$val['date-name'] == 'День' ? 'selected' : ''?> value="День">День</option>
                            <option <?=$val['date-name'] == 'Месяц' ? 'selected' : ''?> value="Месяц">Месяц</option>
                            <option <?=$val['date-name'] == 'Год' ? 'selected' : ''?> value="Год">Год</option>
                        </select>
                    </div>
                    <div class="type_rate">
                    ...
                    <div class="description">
                        <textarea name="extra[rate][<?=$key?>][description]" placeholder="Краткое описание"><?=$val['description']?></textarea>
                    </div>
                    <div class="tag-list" data-tag>
